                ...
                <a-col :span="17">
                    <div class="setting-base">
                        ...
                        <div class="settings-list border-b">
                            ...
                            <div class="nickname">
                                <a-input v-model:value="user.nickname" style="background-color: #F7F7F7;"
                                    :bordered="false" placeholder="输入昵称"></a-input>
                            </div>
                        </div>
                        <div class="settings-list border-b">
                            <div class="item-line">
                        ...
                        <div class="save-btn" @click="saveAll">
...
const beforeUpload = (file) => {
    ...
    uploadCosFetch({
        ...
        const userInfo=useCookie('userInfo',{maxAge:60*60*24*7*10})
