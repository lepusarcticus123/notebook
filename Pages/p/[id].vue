                    ...
                    <div class="author-box">
                        ...
                        <div class="author-info">
                            <NuxtLink>
                                <a-avatar :size="44">
                                    <template #icon>
                                        <img :src="noteData.author.avatar ? noteData.author.avatar : '/images/default-avatar.png'"
                                            alt="avatar">
                                    </template>
                                </a-avatar>
                            </NuxtLink>
                            <div class="author-des">
                                <a-row type="flex" align="middle">
                                    ...
                                    <a-button style=" height: 22px;padding: 0 6px;font-size: 12px;margin-left: 6px"
                                        shape="round" size="small" danger>关注</a-button>
                                    <span class="ip">IP属地：成都</span>
                                </a-row>
                                <a-row type="flex" align="middle" style="margin-top: 6px">
                                    <span class="jsd-meta"><i-ion-diamond />136.0</span>
                                    <span
                                        class="ip">{{ moment(noteData.created_at).format('YYYY-MM-DD:HH:mm:ss') }}</span>
                ...
                <a-col :span="6" class="right-sider">
                    <div class="right-author">
                        <div class="author-des" style="border-bottom: 1px solid #f0f0f0;padding-bottom: 10px">
                            <a-row type="flex" align="middle">
                                <span style="flex: 1">{{ noteData.author.nickname }}</span>
                                <a-button style=" height: 22px;padding: 0 6px;font-size: 12px;margin-left: 6px"
                                    shape="round" size="small" danger>关注</a-button>
                            </a-row>
                            <a-row type="flex" align="middle" style="margin-top: 6px">
...
console.log('data', noteData.value)
//关键字设置
useHead({
    title: noteData.title,
    meta: [
        { name: 'description', content: noteData.subTitle },
        { name: 'keywords', content: noteData.subTitle }
    ],
})
</script>
