    ...
    <a-row style="height: 100vh">
            ...
            <div class="notebook">
                <div class="notebook-top">
                    ...
                    <div class="create-notebook" v-if="showCreateNb">
                        <a-input class="notebook-input" placeholder="请输入文集名称..."></a-input>
                        <div class="action-box">
                            <a-button size="small" shape="round" ghost>提交</a-button>
                            <a-button @click="showCreateNb = false" style="color: #9a9a9a" type="text">取消</a-button>
                        </div>
                    </div>
                </div>
                <div class="notebook-center">
                    <div class="notebook-c-item active">
                        <span>我的随笔</span>
        ...
        <a-col :span="5" class="note-writer-list">
            ...
            <div class="note-create">
                <div class="note-create-item active">
        ...
        <a-col :span="15">
            ...
            <div class="edit-note">
                ...
                <Editor :value="content" :plugins="plugins" @change="handleChange" :uploadImages="uploadImages" />
            </div>
        </a-col>

    </a-row>
    <!--修改文集弹框-->
    <a-modal v-model:visible="editVisible" width="25%" title="修改文集" okText="提交" cancelText="取消" @ok="handleOk">
        <a-input style="height: 40px" placeholder="输入文集名称"></a-input>
    </a-modal>
    <!--删除文集弹框-->
    <a-modal v-model:visible="deleteVisible" width="20%" okText="提交" cancelText="取消" @ok="deleteHandle">
        <div>
            <p style="margin-top: 30px">确认删除文集《000》，文章将被移动到回收站。</p>
        </div>
    </a-modal>
</template>
...
//获取文集
const {data:notebookData}=await notebookFetch({
    method:'GET',
    server:true,
    key:'notebookFetch', 
})
