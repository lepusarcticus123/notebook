                ...
                <a-row>
                    <a-col :span="12">
                        <a-row class="login-left" type="flex" justify="end">
                            ...
                            <a-row>
                                <a-button style="width: 250px;height: 45px" shape="round" size="large"
                                    type="primary">下载简书APP</a-button>
                                <a-popover placement="topRight">
                                    <template #content>
                                        <div class="page_download">
                                            <img style="width: 100px" src="/images/login_page_download.png"
                                                alt="download" />
                                        </div>
                                    </template>
                                    <div class="page_download">
                            ...
                            <div class="login-form">
                                ...
                                <div class="form">
                                    <a-form :model="formState">
                                        <a-form-item>
                                            <a-input style="border: none;background-color: #F7F7F7 !important;"
                                                placeholder="手机号或邮箱" v-model:value="formState.phone">
                                                <template #prefix>
                                                    <i-ep-user-filled />
                                                </template>
                                            </a-input>
                              ...
                              background-color: #F7F7F7 !important;" placeholder="密码" type="password"
                                ...
                                <a-row type="flex" justify="center" class="sign_in_btn">
                                    <a-button shape="round" @click="login">
                                        登录
                                    </a-button>
                                </a-row>
                                <div class="more-sign">
                                    ...
                                    <a-row type="flex" justify="center" style="margin-top: 30px">
                                        <div><i-ant-design-weibo-outlined style="color: #E05344;font-size: 30px" />
                                        </div>
                                        <div style="margin: 0 30px"><i-ant-design-wechat-outlined
